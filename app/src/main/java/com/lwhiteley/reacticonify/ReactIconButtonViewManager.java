 ...
 */
public class ReactIconButtonViewManager extends SimpleViewManager<IconButton> {
    public static final String REACT_CLASS = "RCTIconButton";
    ...
    @Override
    public IconButton createViewInstance(ThemedReactContext context) {
        Log.i("IconTextView", "create instance");
        return new IconButton(context);
    }

    @Override
    public void updateView(final IconButton view,
